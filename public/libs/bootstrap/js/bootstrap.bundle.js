...
(function (global, factory) {
  ...
  */
  ...
  /**
   * --------------------------------------------------------------------------
   * Bootstrap (v5.3.0-alpha1): modals.js
   * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
   * --------------------------------------------------------------------------
   */
  ...
  const CLASS_NAME_OPEN = 'modals-open';
  const CLASS_NAME_FADE$3 = 'fade';
  const CLASS_NAME_SHOW$4 = 'show';
  const CLASS_NAME_STATIC = 'modals-static';
  const OPEN_SELECTOR$1 = '.modals.show';
  const SELECTOR_DIALOG = '.modals-dialog';
  const SELECTOR_MODAL_BODY = '.modals-body';
  const SELECTOR_DATA_TOGGLE$2 = '[data-bs-toggle="modals"]';
  const Default$6 = {
    backdrop: true,
    focus: true,
    keyboard: true
  ...
  EventHandler.on(document, EVENT_CLICK_DATA_API$2, SELECTOR_DATA_TOGGLE$2, function (event) {
    ...
    // avoid conflict when clicking modals toggler while another one is open
  ...
  EventHandler.on(window, EVENT_RESIZE, () => {
    for (const element of SelectorEngine.find('[aria-modals][class*=show][class*=offcanvas-]')) {
  ...
  const CLASS_NAME_MODAL = 'modals';
  const CLASS_NAME_SHOW$2 = 'show';
  const SELECTOR_TOOLTIP_INNER = '.tooltip-inner';
  const SELECTOR_MODAL = `.${CLASS_NAME_MODAL}`;
  const EVENT_MODAL_HIDE = 'hide.bs.modals';
